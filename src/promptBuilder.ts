...
export class PromptBuilder {
  ...
  static step1Prompt(state: ProjectState): string {
  ...
  static step2Prompt(state: ProjectState): string {
  ...
  static step3PagePrompt(pageName: string, state: ProjectState): string {
  ...
  static step4Prompt(state: ProjectState): string {
  ...
  static step5Prompt(state: ProjectState): string {
  ...
  static step6Prompt(state: ProjectState): string {
